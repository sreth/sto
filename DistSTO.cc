...
DistSTO_advance_args::~DistSTO_advance_args() throw() {
}


uint32_t DistSTO_advance_args::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t DistSTO_advance_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("DistSTO_advance_args");
...
DistSTO_advance_pargs::~DistSTO_advance_pargs() throw() {
}


uint32_t DistSTO_advance_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("DistSTO_advance_pargs");
...
DistSTO_advance_result::~DistSTO_advance_result() throw() {
}


uint32_t DistSTO_advance_result::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t DistSTO_advance_result::write(::apache::thrift::protocol::TProtocol* oprot) const {

  uint32_t xfer = 0;

  xfer += oprot->writeStructBegin("DistSTO_advance_result");
...
DistSTO_advance_presult::~DistSTO_advance_presult() throw() {
}


uint32_t DistSTO_advance_presult::read(::apache::thrift::protocol::TProtocol* iprot) {
...
DistSTO_transmit_args::~DistSTO_transmit_args() throw() {
}


uint32_t DistSTO_transmit_args::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t DistSTO_transmit_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("DistSTO_transmit_args");
...
DistSTO_transmit_pargs::~DistSTO_transmit_pargs() throw() {
}


uint32_t DistSTO_transmit_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("DistSTO_transmit_pargs");
...
DistSTO_transmit_result::~DistSTO_transmit_result() throw() {
}


uint32_t DistSTO_transmit_result::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t DistSTO_transmit_result::write(::apache::thrift::protocol::TProtocol* oprot) const {
...
DistSTO_transmit_presult::~DistSTO_transmit_presult() throw() {
}


uint32_t DistSTO_transmit_presult::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t DistSTO_do_rpc_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("opargs", ::apache::thrift::protocol::T_STRUCT, 1);
  xfer += this->opargs.write(oprot);
  xfer += oprot->writeFieldEnd();
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->titems.resize(_size16);
            uint32_t _i20;
            for (_i20 = 0; _i20 < _size16; ++_i20)
            {
              xfer += iprot->readBinary(this->titems[_i20]);
            }
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->preceding_duplicate_read_.resize(_size21);
            uint32_t _i25;
            for (_i25 = 0; _i25 < _size21; ++_i25)
            {
              xfer += iprot->readBool(this->preceding_duplicate_read_[_i25]);
            }
            xfer += iprot->readListEnd();
          }
...
uint32_t DistSTO_lock_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("titems", ::apache::thrift::protocol::T_LIST, 2);
  {
    ...
    for (_iter28 = (*(this->titems)).begin(); _iter28 != (*(this->titems)).end(); ++_iter28)
    {
  ...
  {
    xfer += oprot->writeListBegin(::apache::thrift::protocol::T_BOOL, static_cast<uint32_t>((*(this->preceding_duplicate_read_)).size()));
    std::vector<bool> ::const_iterator _iter29;
    for (_iter29 = (*(this->preceding_duplicate_read_)).begin(); _iter29 != (*(this->preceding_duplicate_read_)).end(); ++_iter29)
    {
      xfer += oprot->writeBool((*_iter29));
    }
    xfer += oprot->writeListEnd();
  }
  xfer += oprot->writeFieldEnd();
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->titems.resize(_size30);
            uint32_t _i34;
            for (_i34 = 0; _i34 < _size30; ++_i34)
            {
              xfer += iprot->readBinary(this->titems[_i34]);
            }
            xfer += iprot->readListEnd();
          }
          this->__isset.titems = true;
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->preceding_duplicate_read_.resize(_size35);
            uint32_t _i39;
            for (_i39 = 0; _i39 < _size35; ++_i39)
            {
              xfer += iprot->readBool(this->preceding_duplicate_read_[_i39]);
            }
            xfer += iprot->readListEnd();
          }
          this->__isset.preceding_duplicate_read_ = true;
...
uint32_t DistSTO_check_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("titems", ::apache::thrift::protocol::T_LIST, 2);
  {
    ...
    for (_iter40 = this->titems.begin(); _iter40 != this->titems.end(); ++_iter40)
    {
  ...
  {
    xfer += oprot->writeListBegin(::apache::thrift::protocol::T_BOOL, static_cast<uint32_t>(this->preceding_duplicate_read_.size()));
    std::vector<bool> ::const_iterator _iter41;
    for (_iter41 = this->preceding_duplicate_read_.begin(); _iter41 != this->preceding_duplicate_read_.end(); ++_iter41)
    {
      xfer += oprot->writeBool((*_iter41));
    }
    xfer += oprot->writeListEnd();
  }
  xfer += oprot->writeFieldEnd();
...
uint32_t DistSTO_check_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("titems", ::apache::thrift::protocol::T_LIST, 2);
  {
    ...
    for (_iter42 = (*(this->titems)).begin(); _iter42 != (*(this->titems)).end(); ++_iter42)
    {
  ...
  xfer += oprot->writeFieldBegin("preceding_duplicate_read_", ::apache::thrift::protocol::T_LIST, 4);
  {
    ...
    for (_iter43 = (*(this->preceding_duplicate_read_)).begin(); _iter43 != (*(this->preceding_duplicate_read_)).end(); ++_iter43)
    {
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->write_values.resize(_size44);
            uint32_t _i48;
            for (_i48 = 0; _i48 < _size44; ++_i48)
            {
              xfer += iprot->readBinary(this->write_values[_i48]);
            }
            xfer += iprot->readListEnd();
          }
...
uint32_t DistSTO_install_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("write_values", ::apache::thrift::protocol::T_LIST, 3);
  {
    ...
    for (_iter49 = this->write_values.begin(); _iter49 != this->write_values.end(); ++_iter49)
    {
...
uint32_t DistSTO_install_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("write_values", ::apache::thrift::protocol::T_LIST, 3);
  {
    ...
    for (_iter50 = (*(this->write_values)).begin(); _iter50 != (*(this->write_values)).end(); ++_iter50)
    {
...
void DistSTOClient::advance()
{
  send_advance();
  recv_advance();
}

void DistSTOClient::send_advance()
{
  int32_t cseqid = 0;
  oprot_->writeMessageBegin("advance", ::apache::thrift::protocol::T_CALL, cseqid);

  DistSTO_advance_pargs args;
  args.write(oprot_);
...
void DistSTOClient::recv_advance()
{
  ...
  if (fname.compare("advance") != 0) {
    iprot_->skip(::apache::thrift::protocol::T_STRUCT);
    iprot_->readMessageEnd();
    iprot_->getTransport()->readEnd();
  }
  DistSTO_advance_presult result;
  result.read(iprot_);
  iprot_->readMessageEnd();
  iprot_->getTransport()->readEnd();
...
void DistSTOClient::do_rpc(DoRpcResponse& _return, const DoRpcArgs& opargs)
{
  send_do_rpc(opargs);
  recv_do_rpc(_return);
}

void DistSTOClient::send_do_rpc(const DoRpcArgs& opargs)
{
  int32_t cseqid = 0;
...
void DistSTOClient::recv_do_rpc(DoRpcResponse& _return)
{
...
void DistSTOProcessor::process_advance(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("DistSTO.advance", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "DistSTO.advance");

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preRead(ctx, "DistSTO.advance");
  }

  DistSTO_advance_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postRead(ctx, "DistSTO.advance", bytes);
  }

  DistSTO_advance_result result;
  try {
    iface_->advance();
  } catch (const std::exception& e) {
    if (this->eventHandler_.get() != NULL) {
      this->eventHandler_->handlerError(ctx, "DistSTO.advance");
    }

    ::apache::thrift::TApplicationException x(e.what());
    oprot->writeMessageBegin("advance", ::apache::thrift::protocol::T_EXCEPTION, seqid);
    x.write(oprot);
    oprot->writeMessageEnd();
    oprot->getTransport()->writeEnd();
    oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preWrite(ctx, "DistSTO.advance");
  }

  oprot->writeMessageBegin("advance", ::apache::thrift::protocol::T_REPLY, seqid);
  result.write(oprot);
  oprot->writeMessageEnd();
  bytes = oprot->getTransport()->writeEnd();
  oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postWrite(ctx, "DistSTO.advance", bytes);
  }
}

void DistSTOProcessor::process_transmit(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("DistSTO.transmit", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "DistSTO.transmit");

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preRead(ctx, "DistSTO.transmit");
  }

  DistSTO_transmit_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postRead(ctx, "DistSTO.transmit", bytes);
  }
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preWrite(ctx, "DistSTO.transmit");
  }
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postWrite(ctx, "DistSTO.transmit", bytes);
  }
}
...
void DistSTOProcessor::process_do_rpc(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  try {
    iface_->do_rpc(result.success, args.opargs);
    result.__isset.success = true;
  } catch (const std::exception& e) {
    if (this->eventHandler_.get() != NULL) {
...
void DistSTOConcurrentClient::advance()
{
  int32_t seqid = send_advance();
  recv_advance(seqid);
}

int32_t DistSTOConcurrentClient::send_advance()
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("advance", ::apache::thrift::protocol::T_CALL, cseqid);
...
void DistSTOConcurrentClient::recv_advance(const int32_t seqid)
{
...
void DistSTOConcurrentClient::do_rpc(DoRpcResponse& _return, const DoRpcArgs& opargs)
{
  int32_t seqid = send_do_rpc(opargs);
  recv_do_rpc(_return, seqid);
}

int32_t DistSTOConcurrentClient::send_do_rpc(const DoRpcArgs& opargs)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("do_rpc", ::apache::thrift::protocol::T_CALL, cseqid);
...
void DistSTOConcurrentClient::recv_do_rpc(DoRpcResponse& _return, const int32_t seqid)
{
